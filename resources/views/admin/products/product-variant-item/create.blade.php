        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{route('admin.products.index')}}">{{$product->name}}</a></div>
                <div class="breadcrumb-item"><a href="{{route('admin.products-variant.index', ['product' => $product->id])}}">Variants</a></div>
                <div class="breadcrumb-item"><a href="{{ url()->previous() }}">{{$variant->name}}</a></div>
