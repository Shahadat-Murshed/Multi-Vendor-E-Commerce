<header>
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-4 col-7 col-md-8 col-lg-4">
            ...
            <div class="col-xl-4 col-3 col-md-3 col-lg-4">
                <div class="wsus__call_icon_area">
                    ...
                    <ul class="wsus__icon_area">
                        <li>
                            <a href="wishlist.html"><i class="fal fa-heart"></i><span>05</span></a>
                        </li>
                        <li>
                            <a href="compare.html"><i class="fal fa-random"></i><span>03</span></a>
                        </li>
                        <li>
                            <a class="wsus__cart_icon" href="#"><i class="fal fa-shopping-bag"></i><span
    ...
    <div class="wsus__mini_cart">
        <h4>
            shopping cart
            <span class="wsus_close_mini_cart"><i class="far fa-times"></i></span>
        </h4>
            ...
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{ $sidebarProduct->rowId }}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <br>
                        <small>Total:
                            {{ $settings->currency_icon . ($sidebarProduct->price + $sidebarProduct->options->variants_total) * $sidebarProduct->qty }}</small>
                    </div>
                </li>
            @endforeach
