            ...
            <div class="row">
                            ...
                            <table>
                                <tbody>
                                    ...
                                    @foreach ($cartItems as $item)
                                        <tr class="d-flex">
                                            <td height= "120px" class="wsus__pro_img"><img src="{{ asset($item->options->image) }}"
                                                    alt="product" class="img-fluid w-100 ms-3">
                                            </td>
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        ...
                        <a class="common_btn cart_btn mt-4 w-100 text-center" href="{{ route('user.checkout') }}">checkout</a>
