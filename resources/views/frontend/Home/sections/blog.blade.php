        ...
        <div class="row home_blog_slider">
                    ...
                    <div class="wsus__blog_text">
                        ...
                        <div class="wsus__blog_text_center">
                            <a href="blog_details.html"
                                >New found the women’s shirt for summer
                                season</a
                            >
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    ...
                    <div class="wsus__blog_text">
                        ...
                        <div class="wsus__blog_text_center">
                            <a href="blog_details.html"
                                >Fusce lacinia arcuet nulla menasious</a
                            >
                            <p class="date">nov 04 2021</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    ...
                    <div class="wsus__blog_text">
                        ...
                        <div class="wsus__blog_text_center">
                            <a href="blog_details.html"
                                >found the men’s shirt for summer season</a
                            >
                            <p class="date">nov 04 2021</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img
                            src="{{ asset('frontend/images') }}/blog_4.jpg"
                            alt="blog"
                            class="img-fluid w-100"
                        />
                    </a>
                    <div class="wsus__blog_text">
                        ...
                        <div class="wsus__blog_text_center">
                            <a href="blog_details.html"
                                >winter collection for women’s</a
                            >
                            <p class="date">nov 04 2021</p>
                        </div>
                    </div>
            ...
            <div class="col-xl-3">
                <div class="wsus__single_blog wsus__single_blog_2">
                    <a class="wsus__blog_img" href="#">
                        <img
                            src="{{ asset('frontend/images') }}/blog_5.jpg"
                            alt="blog"
                            class="img-fluid w-100"
                        />
                    </a>
                    <div class="wsus__blog_text">
                        ...
                        <div class="wsus__blog_text_center">
                            <a href="blog_details.html"
                                >Comes a cool blog post with {{
                                asset('frontend/images') }}</a
                            >
                            <p class="date">nov 04 2021</p>
                        </div>
                    </div>
