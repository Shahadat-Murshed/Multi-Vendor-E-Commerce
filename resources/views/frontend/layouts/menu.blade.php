            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        <li>
                            <a class="wsus__droap_arrow" href="#"><i class="fal fa-tshirt"></i> Fashion
                            </a>
                        ...
                        <li>
                            <a class="wsus__droap_arrow" href="#"><i class="fas fa-tv"></i> Electronics</a>
                            <ul class="wsus_menu_cat_droapdown">
                                <li>
                                    <a href="#">New Arrivals
                                        <i class="fas fa-angle-right"></i></a>
                        ...
                        <li>
                            <a class="wsus__droap_arrow" href="#"><i class="fas fa-chair-office"></i>
                                Furniture</a>
                            <ul class="wsus_menu_cat_droapdown">
                                <li>
                                    <a href="#">New Arrivals
                        ...
                        <li>
                            <a class="wsus__droap_arrow" href="#"><i class="fal fa-mobile"></i> Smart
                                Phones</a>
                            <ul class="wsus_menu_cat_droapdown">
                                <li>
                                    <a href="#">New Arrivals
                        ...
                        <li>
                            <a href="#"><i class="fas fa-home-lg-alt"></i> Home &
                                Garden</a>
                        </li>
                        <li>
                            <a href="#"><i class="far fa-camera"></i> Accessories</a>
                        </li>
                        <li>
                            <a href="#"><i class="fas fa-heartbeat"></i> Healthy &
                                Beauty</a>
                        </li>
                        <li>
                            <a href="#"><i class="fal fa-gift-card"></i> Gift Ideas</a>
                        </li>
                        <li>
                            <a href="#"><i class="fal fa-gamepad-alt"></i> Toy &
                                Games</a>
                        </li>
                        <li>
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li>
                            <a href="product_grid_view.html">shop <i class="fas fa-caret-down"></i></a>
                    ...
                    <ul class="wsus_mobile_menu_category">
                        ...
                        <li>
                            <a href="#" class="accordion-button collapsed" data-bs-toggle="collapse"
                                ...
                                aria-controls="flush-collapseThreerrw"><i class="fal fa-mobile"></i> Smart Phones</a>
