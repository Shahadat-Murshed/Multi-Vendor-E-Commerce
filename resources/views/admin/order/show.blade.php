                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 text-md-right">
                        <address>
                            <strong style="text-transform: uppercase">preferable Delivery Time:</strong><br>
                            <b>{{$order->delivery_time}}</b><br>
                            <br>
                            <br>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                              <a href="{{route('admin.asign-delivery', $order->id)}}">
                                <button class="mt-4 col-md-12 btn btn-primary icon-left"><i class="fas fa-truck"></i> Assign A Delivery Guy</button>
                              </a>
                          </div>
                        </div>
                      </div>
