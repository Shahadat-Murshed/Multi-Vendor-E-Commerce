        ...
        <ul>
                ...
                <div class="wsus__cart_img">
                    <a href="#"
                        ><img
                            ...
                            class="img-fluid w-100"
                    /></a>
                    <a class="wsis__del_icon" href="#"
                        ><i class="fas fa-minus-circle"></i
                    ></a>
                </div>
                <div class="wsus__cart_text">
                    <a class="wsus__cart_title" href="#"
                        >apple 9.5" 7 serise tab with full view display</a
                    >
                    <p>$140 <del>$150</del></p>
                </div>
            </li>
            <li>
                <div class="wsus__cart_img">
                    <a href="#"
                        ><img
                            src="{{asset('frontend/images')}}/pro4.jpg"
                            alt="product"
                            class="img-fluid w-100"
                    /></a>
                    <a class="wsis__del_icon" href="#"
            ...
            <li>
                ...
                <div class="wsus__cart_text">
                    <a class="wsus__cart_title" href="#"
                        >men's fashion casual sholder bag</a
                    >
                    <p>$140</p>
                </div>
            </li>
